...
⚠️  DEPRECATED FEATURES:
    - LLM Mood Playlists (generate_llm): Use t_playlist_gen_v2 instead
...
_normalize_artist_name = normalize_artist_name
_extract_all_artists = extract_all_artists
_artist_matches = artist_matches
...
def generate_llm(
    ...
    """
    ⚠️  DEPRECATED: LLM-based mood playlist generation.
    
    This function is deprecated and will be removed in a future version.
    
    RECOMMENDED ALTERNATIVE:
    Use t_playlist_gen_v2.generate_mood_playlists() instead, which provides:
    - 8 moods based on Thayer's model (IEEE paper)
    - 94.44% accuracy
    - No API costs
    - Instant generation
    ...
    import warnings
    warnings.warn(
        "generate_llm() is deprecated. Use t_playlist_gen_v2.generate_mood_playlists() instead.",
        DeprecationWarning,
        stacklevel=2
    )
